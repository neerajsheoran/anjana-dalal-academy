...
const ANALOGIES_BANK: Record<'easy' | 'medium' | 'hard', Analogy[]> = {
  ...
  hard: [
    ...
    { a: 'Drought', b: 'Famine',  c: 'Storm',     correct: 'Flood',     distractors: ['Drought', 'Earthquake', 'Fire'], relationship: 'cause → effect' },
    ...
    { a: 'Honey',  b: 'Sweet',   c: 'Lemon',      correct: 'Sour',      distractors: ['Bitter', 'Sweet', 'Spicy'],     relationship: 'food → its taste' },
