...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: CloudRain, name: 'rain cloud' },
      { icon: CloudLightning, name: 'lightning' },
    ],
  },
  {
    key: 'plants',
    ...
    items: [
      ...
      { icon: TreeDeciduous, name: 'leafy tree' },
  ...
  // New categories below — all manmade cluster, distinct sub-clusters
  // so they don't collide with each other on "very-near" rounds.
  {
    key: 'instruments',
