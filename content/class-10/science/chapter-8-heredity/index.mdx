...
chapterKey: "493e055c-ccf9-40c6-829a-6d7b52d91a8a"
...
![Gregor Mendel — father of genetics and his pea plant experiments](mendel-1.png)
...
![Pea plants were ideal for genetics — contrasting traits, controlled pollination](mendel-2.png)
...
![Dihybrid cross — 9:3:3:1 ratio showing independent assortment](dihybrid-cross.png)
...
![Genes code for proteins — from gene to trait](genes-to-traits.png)
...
![Genes reside on chromosomes — diploid body cells, haploid gametes](genes-on-chromosomes.png)
...
**Pusa wheat varieties — Mendel's logic in Indian fields.** The Indian Agricultural Research Institute (IARI) at Pusa, Delhi, has been releasing new wheat varieties for decades — Pusa Tejas, Pusa Basant, HD 2967 and many more. Each is created by carefully cross-pollinating two parent varieties — one with high yield, the other with disease resistance, for instance — and tracking traits across F1, F2, and later generations. This is exactly the methodology Mendel used with his pea plants in a monastery garden in 1860s Czechoslovakia. The chapter you are studying is the working manual of the scientists who feed India.

**The PCPNDT Act and why blaming the mother is biologically wrong.** Even today in parts of India, families wrongly blame a mother if she gives birth to daughters. The science in this chapter shows this is baseless — the mother only contributes X chromosomes; it is the father's sperm (X-bearing or Y-bearing) that decides the sex. The Pre-Conception and Pre-Natal Diagnostic Techniques (PCPNDT) Act, 1994, makes prenatal sex determination illegal precisely because the misuse of ultrasound for sex-selective abortion has skewed India's child sex ratio. The biology in your textbook is the legal and ethical bedrock of an entire social reform.

**Earlobes, dimples, and tongue-rolling at family weddings.** At any large Indian wedding gathering, look around your relatives. Some have attached earlobes, some have free-hanging ones. Some can roll their tongue into a U-shape, some cannot. Some have dimples, most do not. These are exactly the kinds of single-gene Mendelian traits the chapter describes — one dominant allele often enough to express the trait, recessive trait appearing only when both copies are recessive. The whole family is a living Punnett square.

### Try it at home — the family trait tree

*⏱ 45 minutes over 2 sessions · 🧹 zero mess · 👨‍👩‍👧 no adult help needed, but you'll be surveying 6-10 family members*

**What you'll need:**

- A notebook and pen.
- A small mirror.
- Patience and a willingness to ask relatives about their parents and grandparents too.

**Steps:**

1. **Pick one trait.** Choose ONE of these to track: attached vs free earlobes; ability to roll tongue into a U-shape; presence of dimples when smiling; widow's peak (V-shaped hairline) vs straight hairline.
2. **Survey your nuclear family first.** Yourself, siblings, both parents. Note who has the trait and who does not.
3. **Extend to grandparents and aunts/uncles.** Ask your parents about their parents and siblings. Even if some are no longer around, family memory usually preserves these details.
4. **Draw a family tree** — a simple chart with rectangles for males and circles for females. Shade in the people who have the trait (say, free earlobes). Leave unshaded those who do not.
5. **Spot the inheritance pattern.** Does the trait appear in every generation, or does it skip? Do two parents WITHOUT the trait sometimes have a child WITH it? That is the recessive trait reappearing — exactly the 3:1 pattern Mendel saw.
6. **Try writing the genotypes.** If "free earlobes" is dominant (F) and "attached" is recessive (f), can you guess at the genotype of each person? People with attached lobes must be ff. People with free lobes are either FF or Ff — sometimes you can deduce which from their children.

**What to look for:**

- Does any couple — both with the dominant trait — have a child with the recessive trait? If yes, both parents must be heterozygous (Ff × Ff → 3:1 ratio possible).
- Does the trait appear roughly equally in males and females? If yes, it is autosomal, not sex-linked.
- Did you notice the recessive trait skipping a generation? That is the textbook signature of recessive inheritance.

**Show what you found:** Show your family tree to your daadi (or dadu, mummy, or older cousin). Explain what their earlobe (or dimple, or tongue-roll) reveals about their genotype. Tell them one thing — that the trait skipped a generation because a recessive gene stayed hidden. Watch them connect their own face in the mirror to Gregor Mendel's pea plants from 160 years ago.

**A question to keep asking all year:** *When I look at any trait in my family — height, eye colour, hair texture, even the way people laugh — which of those are written in the genes, which are shaped by environment, and which are a mix of both?*
