...
![Fission — binary and multiple, in Amoeba and Plasmodium](fission.png)
...
![Fragmentation — Spirogyra filaments breaking into new individuals](fragmentation.png)
...
![Regeneration — Planaria and Hydra regrowing from body fragments](regeneration.png)
...
![Budding — new individual growing as a bulge in Hydra and yeast](budding.png)
...
![Vegetative propagation — stems, tubers, roots, and leaves growing new plants](vegetative-propagation.png)
...
![Spore formation — Rhizopus releasing spores from a sporangium](spore-formation.png)
...
![Sexual reproduction — two parents contributing gametes for genetic variety](sexual-reproduction.png)
...
![Pollination — self-pollination and cross-pollination pathways](pollination.png)
...
![Seed and fruit formation — ovule becomes seed, ovary becomes fruit](fertilisation-seed-2.png)
