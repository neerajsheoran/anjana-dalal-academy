...
![Oersteds experiment — compass needle deflecting near a current-carrying wire](introduction.png)
...
![Properties of magnetic field lines — closed loops, no crossing, density shows strength](field-lines-properties.png)
...
![Magnetic field of a circular loop — like a short bar magnet](circular-loop.png)
...
![Solenoid — uniform interior field, becomes an electromagnet with iron core](solenoid.png)
...
![Electric motor components — armature coil, commutator, brushes, magnets](motor-components.png)
...
![Where electric motors are used — fans, pumps, appliances, vehicles](motor-applications.png)
...
![Electromagnetic induction — moving magnet induces current in a coil](electromagnetic-induction.png)
...
![Flemings right-hand rule — direction of induced current](flemings-right-hand-rule.png)
...
![AC vs DC generator — slip rings vs split ring commutator](ac-vs-dc.png)
...
![Domestic electric circuit — live, neutral, earth wires with safety devices](domestic-circuit.png)
