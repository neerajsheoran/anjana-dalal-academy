...
![Potential difference — V = W/Q, measured in volts](potential-difference-1.png)
...
![Voltmeter connected in parallel to measure potential difference](potential-difference-2.png)
...
![Resistance depends on length, area, material, and temperature](resistance-factors.png)
...
![Resistivity of materials — conductors, alloys, insulators](resistivity-materials.png)
...
![Heating effect — H = I^2 R t, Joules law](heating-effect.png)
...
![Everyday applications of heating effect — cooking, lighting, fuses](heating-applications.png)
...
![Why alloys for heating elements — high resistivity, high melting point](why-alloys-heating.png)
...
![Why tungsten for bulb filaments — extreme heat tolerance and high resistivity](why-tungsten-filaments.png)
...
![Why home appliances are wired in parallel — full voltage, independent switching](appliances-parallel.png)
